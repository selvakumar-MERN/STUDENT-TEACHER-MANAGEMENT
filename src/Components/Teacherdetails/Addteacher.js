        ...
        <div id="content">
          ...
          <div className="container-fluid">
            ...
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 className="h3 mb-0 text-gray-800">Add New Teacher</h1>
            </div>
            <form>
              ...
              <div className="form-row">
                ...
                <div className="form-group col-md-6">
                  ...
                  <input type="text" className="form-control" id="inputclassName" name='qualification' onChange={handler} placeholder="qualification"></input>
                </div>
              </div>
